...
var white_balance_warm_color = preload("res://Plugins/FKPostProcessing/Textures/warm_color.res")
var white_balance_cool_color = preload("res://Plugins/FKPostProcessing/Textures/cool_color.res")
